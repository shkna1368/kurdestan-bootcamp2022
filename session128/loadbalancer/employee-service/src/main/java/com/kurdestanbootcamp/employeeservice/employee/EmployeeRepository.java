...
@Repository
public interface EmployeeRepository extends PagingAndSortingRepository<Employee,Long>, ListCrudRepository<Employee, Long>, JpaSpecificationExecutor<Employee> {
