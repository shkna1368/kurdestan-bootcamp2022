...
/*    @Override
 ...
 @ExceptionHandler({BadRequestException.class})
    ...
    protected ResponseEntity<Object> handleNotFoundException(FeignCustomException feignCustomException) {
        ApiError apiError = new ApiError(NOT_FOUND);
        apiError.setMessage(feignCustomException.getMessage()+feignCustomException.status());
        return buildResponseEntity(apiError);
    }
